...
## Get managed resource by host id (Auth roles: Admin,App)

<a id="opIdGetManagedResourceByHostId"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedResource/ByHostId/{hostId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedResource/ByHostId/{hostId} -Headers $Headers
```

`GET /api/v1/ManagedResource/ByHostId/{hostId}`

<h3 id="get-managed-resource-by-host-id-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-managed-resource-by-host-id-(auth-roles:-admin,app)-responses">Responses</h3>

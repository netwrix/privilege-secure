...
## Update member of protected group (Auth roles: Admin,App)

<a id="opIdPutGroupMember"></a>

> Code samples

```shell
# You can also use wget
curl -X PUT /api/v1/ManagedResource/ProtectedGroup/Member \
...
Invoke-RestMethod -Method PUT -Url "$($Host)/api/v1/ManagedResource/ProtectedGroup/Member" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

`PUT /api/v1/ManagedResource/ProtectedGroup/Member`
...
<h3 id="update-member-of-protected-group-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="update-member-of-protected-group-(auth-roles:-admin,app)-responses">Responses</h3>

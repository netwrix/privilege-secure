...
## Search for managed resources (Auth roles: Admin,App)
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedResource/Search -Headers $Headers
```

`GET /api/v1/ManagedResource/Search`

<h3 id="search-for-managed-resources-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
|filterType|Domain|
|filterType|Website|
|filterType|AzureAdTenant|
|filterType|SecretVault|
|filterType|Database|
...
<h3 id="search-for-managed-resources-(auth-roles:-admin,app)-responses">Responses</h3>

...
## Get the current members of a protected group (Auth roles: Admin,App)

<a id="opIdGetCurrentMembers"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedResource/ProtectedGroup/{groupId}/CurrentMembers \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedResource/ProtectedGroup/{groupId}/CurrentMembers -Headers $Headers
```

`GET /api/v1/ManagedResource/ProtectedGroup/{groupId}/CurrentMembers`

<h3 id="get-the-current-members-of-a-protected-group-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-the-current-members-of-a-protected-group-(auth-roles:-admin,app)-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|Inline|

<h3 id="get-the-current-members-of-a-protected-group-(auth-roles:-admin,app)-responseschema">Response Schema</h3>

Status Code **200**

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|[[SbPAM.Models.ProtectedGroupMember](../Models/sbpam.models.protectedgroupmember.md)]|false|none|none|

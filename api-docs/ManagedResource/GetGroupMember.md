...
## Get specific member of a protected group (Auth roles: Admin,App)

<a id="opIdGetGroupMember"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedResource/ProtectedGroup/Member/{memberId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedResource/ProtectedGroup/Member/{memberId} -Headers $Headers
```

`GET /api/v1/ManagedResource/ProtectedGroup/Member/{memberId}`

<h3 id="get-specific-member-of-a-protected-group-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-specific-member-of-a-protected-group-(auth-roles:-admin,app)-responses">Responses</h3>

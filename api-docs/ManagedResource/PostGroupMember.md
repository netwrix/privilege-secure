...
## Add member to protected group (Auth roles: Admin,App)

<a id="opIdPostGroupMember"></a>

> Code samples

```shell
# You can also use wget
curl -X POST /api/v1/ManagedResource/ProtectedGroup/Member \
...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/ManagedResource/ProtectedGroup/Member" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

`POST /api/v1/ManagedResource/ProtectedGroup/Member`
...
<h3 id="add-member-to-protected-group-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="add-member-to-protected-group-(auth-roles:-admin,app)-responses">Responses</h3>

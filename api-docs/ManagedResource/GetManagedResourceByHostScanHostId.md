...
## Get managed resource by hostscan host id (Auth roles: Admin,App)

<a id="opIdGetManagedResourceByHostScanHostId"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedResource/ByHostScanHostId/{hostScanHostId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedResource/ByHostScanHostId/{hostScanHostId} -Headers $Headers
```

`GET /api/v1/ManagedResource/ByHostScanHostId/{hostScanHostId}`

<h3 id="get-managed-resource-by-hostscan-host-id-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|hostScanHostId|path|string(uuid)|true|none|
...
<h3 id="get-managed-resource-by-hostscan-host-id-(auth-roles:-admin,app)-responses">Responses</h3>

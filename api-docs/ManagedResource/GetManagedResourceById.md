...
## Get specific managed resource (Auth)

<a id="opIdGetManagedResourceById"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedResource/{managedResourceId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedResource/{managedResourceId} -Headers $Headers
```
...
<h3 id="get-specific-managed-resource-(auth)-responses">Responses</h3>

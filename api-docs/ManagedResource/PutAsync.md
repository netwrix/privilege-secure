...
## Update managed resource (Auth roles: Admin,App)
...
curl -X PUT /api/v1/ManagedResource/{managedResourceId} \
...
Invoke-RestMethod -Method PUT -Url "$($Host)/api/v1/ManagedResource/{managedResourceId}" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

`PUT /api/v1/ManagedResource/{managedResourceId}`
...
<h3 id="update-managed-resource-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|managedResourceId|path|string(uuid)|true|Managed resource id|
|body|body|[SbPAM.Models.ManagedResourceView](../Models/sbpam.models.managedresourceview.md)|false|none|
...
<h3 id="update-managed-resource-(auth-roles:-admin,app)-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Id in payload does not match id in route|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|
|403|[Forbidden](https://tools.ietf.org/html/rfc7231#section-6.5.3)|User is not an Administrator|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Error has occurred, please see web log|None|

...
curl -X PUT /api/v1/AccessControlPolicy/Copy \
...
Invoke-RestMethod -Method PUT -Url /api/v1/AccessControlPolicy/Copy -ContentType application/json-patch+json -Body $JsonBody
```

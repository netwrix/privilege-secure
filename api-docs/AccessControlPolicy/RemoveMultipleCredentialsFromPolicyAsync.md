...
Invoke-RestMethod -Method PUT -Url "$($Host)/api/v1/AccessControlPolicy/{policyId}/Credential/Remove" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

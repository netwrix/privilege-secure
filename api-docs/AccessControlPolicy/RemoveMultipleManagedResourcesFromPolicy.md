...
Invoke-RestMethod -Method PUT -Url /api/v1/AccessControlPolicy/{policyId}/ManagedResource/Remove -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

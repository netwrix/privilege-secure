...
## Retrieve managed account groups associated with a policy.
...
<h3 id="retrieve-managed-account-groups-associated-with-a-policy.-parameters">Parameters</h3>
...
<h3 id="retrieve-managed-account-groups-associated-with-a-policy.-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|Inline|

<h3 id="retrieve-managed-account-groups-associated-with-a-policy.-responseschema">Response Schema</h3>

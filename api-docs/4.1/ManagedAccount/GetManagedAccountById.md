...
##  (Auth roles: Admin,App,Reviewer)

<a id="opIdGetManagedAccountById"></a>
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedAccount/ByManagedId/{managedAccountId} -Headers $Headers -ContentType "application/json"
```

`GET /api/v1/ManagedAccount/ByManagedId/{managedAccountId}`

<h3 id="-(auth-roles:-admin,app,reviewer)-parameters">Parameters</h3>
...
<h3 id="-(auth-roles:-admin,app,reviewer)-responses">Responses</h3>

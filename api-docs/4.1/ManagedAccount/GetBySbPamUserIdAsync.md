...
<a id="opIdGetBySbPamUserIdAsync"></a>
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedAccount/BySbPamUserId/{id} -Headers $Headers
```

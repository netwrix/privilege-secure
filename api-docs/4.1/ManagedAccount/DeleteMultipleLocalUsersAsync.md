...
Invoke-RestMethod -Method POST -Uri "$($NPSUrl)/api/v1/ManagedAccount/DeleteMultipleLocalUsers" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

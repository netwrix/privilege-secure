...
## Mark the resource test as complete (Auth roles: Admin,App)
...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/ManagedResource/TestConnection/{resourceId}/{testId}/Complete -Headers $Headers -ContentType "application/json"
```

`PUT /api/v1/ManagedResource/TestConnection/{resourceId}/{testId}/Complete`

<h3 id="mark-the-resource-test-as-complete-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="mark-the-resource-test-as-complete-(auth-roles:-admin,app)-responses">Responses</h3>

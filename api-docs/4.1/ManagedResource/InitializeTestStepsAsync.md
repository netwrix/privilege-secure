...
Invoke-RestMethod -Method POST -Uri "$($NPSUrl)/api/v1/ManagedResource/TestConnection/{resourceId}/{testId}/Initialize" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

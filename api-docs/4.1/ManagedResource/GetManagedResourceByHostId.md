...
## Get managed resource by host id (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/ByHostId/{hostId}" -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-managed-resource-by-host-id-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-managed-resource-by-host-id-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

...
## Get specific managed resource (Auth policies: MfaRequired)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/{managedResourceId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-specific-managed-resource-(auth-policies:-mfarequired)-parameters">Parameters</h3>
...
<h3 id="get-specific-managed-resource-(auth-policies:-mfarequired)-responses">Responses</h3>

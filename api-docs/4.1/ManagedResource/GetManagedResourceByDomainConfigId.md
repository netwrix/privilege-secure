...
## Get managed resource for activity directory domain config (Auth roles: Admin,App)
...
<h3 id="get-managed-resource-for-activity-directory-domain-config-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-managed-resource-for-activity-directory-domain-config-(auth-roles:-admin,app)-responses">Responses</h3>

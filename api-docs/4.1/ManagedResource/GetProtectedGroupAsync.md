...
## Get specific protected group for managed resource (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/ProtectedGroup/{groupId}" -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-specific-protected-group-for-managed-resource-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-specific-protected-group-for-managed-resource-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

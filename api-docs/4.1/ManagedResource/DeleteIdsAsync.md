...
Invoke-RestMethod -Method POST -Uri "$($NPSUrl)/api/v1/ManagedResource/Delete" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

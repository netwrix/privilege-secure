...
<h2 id="tocS_SbPAM.Models.ApprovalWorkflowTier">SbPAM.Models.ApprovalWorkflowTier</h2>

<a id="schemasbpam.models.approvalworkflowtier"></a>
<a id="schema_SbPAM.Models.ApprovalWorkflowTier"></a>
<a id="tocSsbpam.models.approvalworkflowtier"></a>
<a id="tocssbpam.models.approvalworkflowtier"></a>
...
This model represents an approval workflow tier.

### Properties

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|id|string(uuid)|false|none|Unique identifier for this workflow tier.|
|approvalWorkflowId|string(uuid)¦null|false|none|Id of workflow to which this tier belongs.|
|tierNumber|integer(int32)|false|none|Tier number (1, ...).|
|progressionType|[SbPAM.Models.ApprovalWorkflowTierProgressionType](../Models/sbpam.models.approvalworkflowtierprogressiontype.md)|false|none|none|
|requiredApprovalCount|integer(int32)|false|none|Number of approvals needed to accomplish this tier.|
|approvalWorkflowTierApprovers|[[SbPAM.Models.ApprovalWorkflowTierApprover](../Models/sbpam.models.approvalworkflowtierapprover.md)]¦null|false|none|List of possible approvers for this tier|
|approvalWorkflowTierApproverGroups|[[SbPAM.Models.ApprovalWorkflowTierApproverGroup](../Models/sbpam.models.approvalworkflowtierapprovergroup.md)]¦null|false|none|List of possible approver groups for this tier|
|escalationTimeout|integer(int32)|false|none|Escalation timeout for normal approval in minutes.|
|escalationApproverAccountId|string(uuid)¦null|false|none|Id of account to which to escalate this approval.|
|escalationApproverAccount|[SbPAM.Models.ManagedAccount](../Models/sbpam.models.managedaccount.md)|false|none|This model represents a managed account.|
|escalationApproverGroupId|string(uuid)¦null|false|none|Id of account group to which to escalate this approval.|
|escalationApproverGroup|[SbPAM.Models.ManagedAccountGroup](../Models/sbpam.models.managedaccountgroup.md)|false|none|This model represents a group of managed accounts.|

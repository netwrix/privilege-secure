...
<h2 id="tocS_SbPAM.Models.ApprovalWorkflowApproval">SbPAM.Models.ApprovalWorkflowApproval</h2>

<a id="schemasbpam.models.approvalworkflowapproval"></a>
<a id="schema_SbPAM.Models.ApprovalWorkflowApproval"></a>
<a id="tocSsbpam.models.approvalworkflowapproval"></a>
<a id="tocssbpam.models.approvalworkflowapproval"></a>
...
This model represents an approval workflow approval.

### Properties

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|id|string(uuid)|false|none|Unique identifier for this workflow approval.|
|modifiedByUserName|string¦null|false|none|Name of user that created this approval.|
|modifiedFromAddress|string¦null|false|none|IP address of user that created this session.|
|modifiedBy|string(uuid)¦null|false|none|Id of user that created this workflow approval.|
|approvalState|[SbPAM.Models.ApprovalWorkflowApprovalState](../Models/sbpam.models.approvalworkflowapprovalstate.md)|false|none|none|
|activitySessionId|string(uuid)|false|none|Id of activity session to which this approval applies.|
|activitySession|[SbPAM.Models.ActivitySession](../Models/sbpam.models.activitysession.md)|false|none|This model represents a session which runs a particular activity such such as granting an user elevated access to a resource.|
|approvalWorkflowTierId|string(uuid)|false|none|Id of approval workflow tier to which this approval applies.|
|approvalWorkflowTier|[SbPAM.Models.ApprovalWorkflowTier](../Models/sbpam.models.approvalworkflowtier.md)|false|none|This model represents an approval workflow tier.|
|approverAccountId|string(uuid)|false|none|Id of managed account which provided this approval.|
|approverAccount|[SbPAM.Models.ManagedAccount](../Models/sbpam.models.managedaccount.md)|false|none|This model represents a managed account.|
|approverType|[SbPAM.Models.ApprovalWorkflowApproverType](../Models/sbpam.models.approvalworkflowapprovertype.md)|false|none|none|
|approverNotes|string¦null|false|none|Notes from approver.|

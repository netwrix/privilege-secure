...
This model represents a policy which can be associated with
    an elevation session.
Policies are matched to a particular group, user and host and sorted by priority

...
## Get scanned host. (Auth roles: Admin,App)
...
curl -X GET /api/v1/HostScanJob/Host/{hostId} \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/HostScanJob/Host/{hostId}" -Headers $Headers -ContentType "application/json"
```


</details>

`GET /api/v1/HostScanJob/Host/{hostId}`

<h3 id="get-scanned-host.-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-scanned-host.-(auth-roles:-admin,app)-responses">Responses</h3>

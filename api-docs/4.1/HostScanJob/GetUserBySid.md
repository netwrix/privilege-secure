...
## Get scanned user by SID. (Auth roles: Admin,App)

<a id="opIdGetUserBySid"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/HostScanJob/User/SID/{sid} \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/HostScanJob/User/SID/{sid} -Headers $Headers
```

`GET /api/v1/HostScanJob/User/SID/{sid}`

<h3 id="get-scanned-user-by-sid.-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-scanned-user-by-sid.-(auth-roles:-admin,app)-responses">Responses</h3>

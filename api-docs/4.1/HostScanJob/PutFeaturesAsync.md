...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/HostScanJob/Features" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
## Update or create scanned host feature. (Auth roles: Admin,App)

<a id="opIdPutFeature"></a>

> Code samples

```shell
# You can also use wget
curl -X PUT /api/v1/HostScanJob/Feature \
...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/HostScanJob/Feature" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

`PUT /api/v1/HostScanJob/Feature`
...
<h3 id="update-or-create-scanned-host-feature.-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="update-or-create-scanned-host-feature.-(auth-roles:-admin,app)-responses">Responses</h3>

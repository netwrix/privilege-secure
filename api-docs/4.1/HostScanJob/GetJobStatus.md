...
## Get status for a host scan job. (Auth roles: Admin,App)

<a id="opIdGetJobStatus"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/HostScanJob/{hostScanJobId} \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/HostScanJob/{hostScanJobId} -Headers $Headers -ContentType "application/json"
```

`GET /api/v1/HostScanJob/{hostScanJobId}`

<h3 id="get-status-for-a-host-scan-job.-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|hostScanJobId|path|string(uuid)|true|Host scan job id|
...
<h3 id="get-status-for-a-host-scan-job.-(auth-roles:-admin,app)-responses">Responses</h3>

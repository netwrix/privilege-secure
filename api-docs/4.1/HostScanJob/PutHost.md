...
## Update scanned host. (Auth roles: Admin,App)
...
curl -X PUT /api/v1/HostScanJob/Host \
...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/HostScanJob/Host" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

`PUT /api/v1/HostScanJob/Host`
...
<h3 id="update-scanned-host.-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[SbPAM.Models.HostScanHost](../Models/sbpam.models.hostscanhost.md)|false|none|
...
<h3 id="update-scanned-host.-(auth-roles:-admin,app)-responses">Responses</h3>

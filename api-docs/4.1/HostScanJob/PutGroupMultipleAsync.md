...
Invoke-RestMethod -Method PUT -Url "$($Host)/api/v1/HostScanJob/Group/Multiple/{actionQueueActionId}" -ContentType "application/json" -Body $JsonBody -Headers $Headers
```

...
## Start a host scan job (Auth roles: Admin,App)

<a id="opIdStartHostScanJobAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/HostScanJob/Host/{hostScanHostId}/Start \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/HostScanJob/Host/{hostScanHostId}/Start -Headers $Headers -ContentType "application/json"
```

`GET /api/v1/HostScanJob/Host/{hostScanHostId}/Start`

<h3 id="start-a-host-scan-job-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="start-a-host-scan-job-(auth-roles:-admin,app)-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|[SbPAM.Models.HostScanHost](../Models/sbpam.models.hostscanhost.md)|

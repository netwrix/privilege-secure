...
Invoke-RestMethod -Method POST -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/AddManagedAccountToMultiplePolicies/{managedAccountId}" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

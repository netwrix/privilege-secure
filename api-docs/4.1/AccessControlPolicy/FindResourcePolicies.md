...
## Retrieve policies by managed resource id. (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/ManagedResource/{managedResourceId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="retrieve-policies-by-managed-resource-id.-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="retrieve-policies-by-managed-resource-id.-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

...
Invoke-RestMethod -Method PUT -Url "$($Host)/api/v1/AccessControlPolicy/{policyId}/ManagedResource/Remove" -ContentType "application/json" -Body $JsonBody -Headers $Headers
```

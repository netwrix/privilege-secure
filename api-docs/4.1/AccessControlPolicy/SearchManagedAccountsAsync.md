...
## Search for managed accounts in given policy. (Auth policies: MfaRequired; roles: Admin,UserPlus)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/SearchManagedAccounts/{accessPolicyId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="search-for-managed-accounts-in-given-policy.-(auth-policies:-mfarequired;-roles:-admin,userplus)-parameters">Parameters</h3>
...
<h3 id="search-for-managed-accounts-in-given-policy.-(auth-policies:-mfarequired;-roles:-admin,userplus)-responses">Responses</h3>

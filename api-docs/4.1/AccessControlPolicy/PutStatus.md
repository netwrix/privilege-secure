...
## Change policy delete/disabled status. (Auth policies: MfaRequired, MfaRequired; roles: Admin)
...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/{accessControlPolicyId}/Status -Headers $Headers -ContentType "application/json"
```
...
<h3 id="change-policy-delete/disabled-status.-(auth-policies:-mfarequired,-mfarequired;-roles:-admin)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|accessControlPolicyId|path|string(uuid)|true|Access control policy id|
|isDeleted|query|boolean|false|Set deleted to true/false (if present)|
|isDisabled|query|boolean|false|Set disabled to true/false (if present)|
...
<h3 id="change-policy-delete/disabled-status.-(auth-policies:-mfarequired,-mfarequired;-roles:-admin)-responses">Responses</h3>

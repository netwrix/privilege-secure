...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/{policyId}/Activity/Remove" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

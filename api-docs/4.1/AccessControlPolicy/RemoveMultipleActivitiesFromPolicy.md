...
## Disassociate activity from a policy. (Auth policies: MfaRequired; roles: Admin,UserPlus)
...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/{policyId}/Activity/Remove" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="disassociate-activity-from-a-policy.-(auth-policies:-mfarequired;-roles:-admin,userplus)-parameters">Parameters</h3>
...
<h3 id="disassociate-activity-from-a-policy.-(auth-policies:-mfarequired;-roles:-admin,userplus)-responses">Responses</h3>

...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/{accessControlPolicyId}" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
Invoke-RestMethod -Method DELETE -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/ManagedGroupAccount/{managedAccountId} -Headers $Headers -ContentType "application/json"
```

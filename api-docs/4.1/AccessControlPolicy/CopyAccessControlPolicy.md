...
Invoke-RestMethod -Method PUT -Url "$($Host)/api/v1/AccessControlPolicy/Copy" -ContentType "application/json" -Body $JsonBody -Headers $Headers
```
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Policy id not sent|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

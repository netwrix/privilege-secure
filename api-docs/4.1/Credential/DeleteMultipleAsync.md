...
Invoke-RestMethod -Method POST -Uri "$($NPSUrl)/api/v1/Credential/DeleteMultiple" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/Credential/GenerateCredentialSSHCertificate/{credentialId}" -ContentType "application/json" -Body $JsonBody -Headers $Headers
```

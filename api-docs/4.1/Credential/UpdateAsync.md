...
## Update an existing credential (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/Credential/{id}" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="update-an-existing-credential-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="update-an-existing-credential-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Id in body doesn't match route|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

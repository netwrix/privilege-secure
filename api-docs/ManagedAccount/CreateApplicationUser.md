...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/ManagedAccount/CreateApplicationUser" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

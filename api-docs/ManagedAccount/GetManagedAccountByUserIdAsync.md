...
## Get NPS user from host user (Auth roles: Admin,App)

<a id="opIdGetManagedAccountByUserIdAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedAccount/ByUserId/{userId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedAccount/ByUserId/{userId} -Headers $Headers
```

`GET /api/v1/ManagedAccount/ByUserId/{userId}`

<h3 id="get-nps-user-from-host-user-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|userId|path|string(uuid)|true|Host user to find|
...
<h3 id="get-nps-user-from-host-user-(auth-roles:-admin,app)-responses">Responses</h3>

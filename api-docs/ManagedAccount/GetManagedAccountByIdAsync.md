...
## Get an NPS user by their Id (Auth roles: Admin,App,Reviewer)

<a id="opIdGetManagedAccountByIdAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedAccount/ByManagedId/{managedAccountId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedAccount/ByManagedId/{managedAccountId} -Headers $Headers
```

`GET /api/v1/ManagedAccount/ByManagedId/{managedAccountId}`

<h3 id="get-an-nps-user-by-their-id-(auth-roles:-admin,app,reviewer)-parameters">Parameters</h3>
...
<h3 id="get-an-nps-user-by-their-id-(auth-roles:-admin,app,reviewer)-responses">Responses</h3>
...
|403|[Forbidden](https://tools.ietf.org/html/rfc7231#section-6.5.3)|User is not and admin and is not requesting their own information|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

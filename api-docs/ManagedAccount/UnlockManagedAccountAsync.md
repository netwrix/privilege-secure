...
## Unlock an NPS user (Auth roles: Admin,App)

<a id="opIdUnlockManagedAccountAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X POST /api/v1/ManagedAccount/{managedAccountId}/Unlock \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/ManagedAccount/{managedAccountId}/Unlock -Headers $Headers
```

`POST /api/v1/ManagedAccount/{managedAccountId}/Unlock`

<h3 id="unlock-an-nps-user-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|managedAccountId|path|string(uuid)|true|User to unlock|
...
<h3 id="unlock-an-nps-user-(auth-roles:-admin,app)-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Error unlocking user|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

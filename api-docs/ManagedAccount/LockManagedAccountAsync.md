...
## Lock an NPS user (Auth roles: Admin,App)

<a id="opIdLockManagedAccountAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X POST /api/v1/ManagedAccount/{managedAccountId}/Lock \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/ManagedAccount/{managedAccountId}/Lock -Headers $Headers
```

`POST /api/v1/ManagedAccount/{managedAccountId}/Lock`

<h3 id="lock-an-nps-user-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|managedAccountId|path|string(uuid)|true|User to lock|
...
<h3 id="lock-an-nps-user-(auth-roles:-admin,app)-responses">Responses</h3>

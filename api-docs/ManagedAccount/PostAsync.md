...
## Create NPS user (Auth roles: Admin,App)

<a id="opIdPostAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X POST /api/v1/ManagedAccount \
...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/ManagedAccount" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

`POST /api/v1/ManagedAccount`
...
<h3 id="create-nps-user-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[SbPAM.Models.ManagedAccount](../Models/sbpam.models.managedaccount.md)|false|NPS user to create|
...
<h3 id="create-nps-user-(auth-roles:-admin,app)-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Error creating user|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

...
## Get NPS user from application user (Auth roles: Admin,App)

<a id="opIdGetManagedAccountByAppUserIdAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedAccount/ByAppUserId/{userId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedAccount/ByAppUserId/{userId} -Headers $Headers
```

`GET /api/v1/ManagedAccount/ByAppUserId/{userId}`

<h3 id="get-nps-user-from-application-user-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|userId|path|string(uuid)|true|Application user to find|
...
<h3 id="get-nps-user-from-application-user-(auth-roles:-admin,app)-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Error finding user|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

...
## Get NPS user by SID (Auth roles: Admin,App)

<a id="opIdGetManagedAccountBySidAsync"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/ManagedAccount/BySid/{sid} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/ManagedAccount/BySid/{sid} -Headers $Headers
```

`GET /api/v1/ManagedAccount/BySid/{sid}`

<h3 id="get-nps-user-by-sid-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|sid|path|string|true|SID to find|
...
<h3 id="get-nps-user-by-sid-(auth-roles:-admin,app)-responses">Responses</h3>

...
## Delete the credential associated with the userid (Auth policies: MfaRequired; roles: Admin,App)
...
<h3 id="delete-the-credential-associated-with-the-userid-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="delete-the-credential-associated-with-the-userid-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/Credential/OnChangeReset" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

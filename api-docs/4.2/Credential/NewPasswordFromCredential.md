...
## Create a copy of an existing credential, generating a new password for the clone (Auth policies: MfaRequired; roles: App)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/Credential/NewCredentialFromCredential/{credentialId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="create-a-copy-of-an-existing-credential,-generating-a-new-password-for-the-clone-(auth-policies:-mfarequired;-roles:-app)-parameters">Parameters</h3>
...
<h3 id="create-a-copy-of-an-existing-credential,-generating-a-new-password-for-the-clone-(auth-policies:-mfarequired;-roles:-app)-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Error has occurred, see web logs for details|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|
|403|[Forbidden](https://tools.ietf.org/html/rfc7231#section-6.5.3)|Internal API for services|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|Source credential not found|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

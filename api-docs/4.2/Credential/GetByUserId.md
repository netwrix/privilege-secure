...
## Get credential by user id (Auth policies: MfaRequired; roles: App)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/Credential/ByUserId/{userId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-credential-by-user-id-(auth-policies:-mfarequired;-roles:-app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|userId|path|string(uuid)|true|User id to find|
|generate|query|boolean|false|True to generate a new password|
|rollback|query|boolean|false|True to rollback to old password|
|showPassword|query|boolean|false|Return password in result|
|save|query|boolean|false|Save the updated password|
...
<h3 id="get-credential-by-user-id-(auth-policies:-mfarequired;-roles:-app)-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Invalid options sent|[Microsoft.AspNetCore.Mvc.ProblemDetails](../Models/microsoft.aspnetcore.mvc.problemdetails.md)|

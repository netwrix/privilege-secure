...
## Get the user associated with the credential (Auth policies: MfaRequired; roles: Admin,App,UserPlus)
...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/Credential/HostUser/{credentialId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-the-user-associated-with-the-credential-(auth-policies:-mfarequired;-roles:-admin,app,userplus)-parameters">Parameters</h3>
...
<h3 id="get-the-user-associated-with-the-credential-(auth-policies:-mfarequired;-roles:-admin,app,userplus)-responses">Responses</h3>

...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/ManagedAccount/UpdateApplicationUser" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

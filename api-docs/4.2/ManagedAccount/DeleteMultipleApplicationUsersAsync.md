...
Invoke-RestMethod -Method POST -Url "$($NPSUrl)/api/v1/ManagedAccount/DeleteMultipleApplicationUsers" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

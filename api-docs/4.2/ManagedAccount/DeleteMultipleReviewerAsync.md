...
Invoke-RestMethod -Method POST -Url "$($NPSUrl)/api/v1/ManagedAccount/Reviewer/DeleteMultiple" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

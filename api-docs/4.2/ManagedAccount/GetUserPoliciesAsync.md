...
## Get list of access policies which NPS user is a member of (Auth roles: Admin,App)

<a id="opIdGetUserPoliciesAsync"></a>
...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/ManagedAccount/{managedAccountId}/Policies -Headers $Headers -ContentType "application/json"
```


</details>

`GET /api/v1/ManagedAccount/{managedAccountId}/Policies`

<h3 id="get-list-of-access-policies-which-nps-user-is-a-member-of-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-list-of-access-policies-which-nps-user-is-a-member-of-(auth-roles:-admin,app)-responses">Responses</h3>
...
<h3 id="get-list-of-access-policies-which-nps-user-is-a-member-of-(auth-roles:-admin,app)-responseschema">Response Schema</h3>

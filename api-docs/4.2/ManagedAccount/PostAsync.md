...
Invoke-RestMethod -Method POST -Uri "$($NPSUrl)/api/v1/ManagedAccount" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

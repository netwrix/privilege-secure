...
<param name="managedResourceId"></param><param name="orderBy"></param><param name="orderDescending"></param><param name="skip"></param><param name="take"></param><param name="startDate"></param><param name="endDate"></param><param name="filterText"></param> (Auth policies: MfaRequired, MfaRequired; roles: Admin)

<a id="opIdGetSessionSummaryByHostAsync"></a>
...
curl -X GET /api/v1/ActivitySession/SummaryForResource/{managedResourceId} \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ActivitySession/SummaryForResource/{managedResourceId}" -Headers $Headers -ContentType "application/json"
```


</details>

`GET /api/v1/ActivitySession/SummaryForResource/{managedResourceId}`

<h3 id="get-all-sessions-for-a-resource
------------
<param-name="managedresourceid"></param><param-name="orderby"></param><param-name="orderdescending"></param><param-name="skip"></param><param-name="take"></param><param-name="startdate"></param><param-name="enddate"></param><param-name="filtertext"></param>-(auth-policies:-mfarequired,-mfarequired;-roles:-admin)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|managedResourceId|path|string(uuid)|true|Managed resource id|
|orderBy|query|string|false|Order by column|
...
|startDate|query|string(date-time)|false|Find sessions starting after this date|
|endDate|query|string(date-time)|false|Find sessions with start dates before this date|
...
<h3 id="get-all-sessions-for-a-resource
------------
<param-name="managedresourceid"></param><param-name="orderby"></param><param-name="orderdescending"></param><param-name="skip"></param><param-name="take"></param><param-name="startdate"></param><param-name="enddate"></param><param-name="filtertext"></param>-(auth-policies:-mfarequired,-mfarequired;-roles:-admin)-responses">Responses</h3>

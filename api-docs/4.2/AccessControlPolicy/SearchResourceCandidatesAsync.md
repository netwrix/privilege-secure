...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/SearchResourceCandidates/{accessPolicyId} -Headers $Headers -ContentType "application/json"
```

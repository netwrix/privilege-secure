...
Invoke-RestMethod -Method POST -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/RemoveManagedAccountFromMultiplePolicies/{managedAccountId}" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

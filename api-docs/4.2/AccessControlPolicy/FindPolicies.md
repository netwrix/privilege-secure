...
## Retrieve policies by managed account/managed resource id pair. (Auth policies: MfaRequired; roles: Admin)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/ManagedAccount/{managedAccountId}/ManagedResource/{managedResourceId}" -Headers $Headers -ContentType "application/json"
```
...
<h3 id="retrieve-policies-by-managed-account/managed-resource-id-pair.-(auth-policies:-mfarequired;-roles:-admin)-parameters">Parameters</h3>
...
<h3 id="retrieve-policies-by-managed-account/managed-resource-id-pair.-(auth-policies:-mfarequired;-roles:-admin)-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|Inline|

<h3 id="retrieve-policies-by-managed-account/managed-resource-id-pair.-(auth-policies:-mfarequired;-roles:-admin)-responseschema">Response Schema</h3>

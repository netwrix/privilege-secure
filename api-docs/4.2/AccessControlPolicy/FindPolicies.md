...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/AccessControlPolicy/ManagedAccount/{managedAccountId}/ManagedResource/{managedResourceId} -Headers $Headers -ContentType "application/json"
```

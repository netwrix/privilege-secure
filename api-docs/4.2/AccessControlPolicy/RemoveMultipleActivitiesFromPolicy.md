...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/AccessControlPolicy/{policyId}/Activity/Remove" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

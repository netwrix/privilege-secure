...
## Create a new policy. (Auth policies: MfaRequired, MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method POST -Url "$($NPSUrl)/api/v1/AccessControlPolicy" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="create-a-new-policy.-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="create-a-new-policy.-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app)-responses">Responses</h3>

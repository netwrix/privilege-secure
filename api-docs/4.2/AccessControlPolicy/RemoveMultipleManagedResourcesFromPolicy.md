...
## Disassociate a managed resource from a policy. (Auth policies: MfaRequired; roles: Admin,UserPlus)
...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/AccessControlPolicy/{policyId}/ManagedResource/Remove" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="disassociate-a-managed-resource-from-a-policy.-(auth-policies:-mfarequired;-roles:-admin,userplus)-parameters">Parameters</h3>
...
<h3 id="disassociate-a-managed-resource-from-a-policy.-(auth-policies:-mfarequired;-roles:-admin,userplus)-responses">Responses</h3>

...
## Update access policy (Auth policies: MfaRequired, MfaRequired; roles: Admin,App,UserPlus)
...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/AccessControlPolicy/{accessControlPolicyId}" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="update-access-policy-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app,userplus)-parameters">Parameters</h3>
...
<h3 id="update-access-policy-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app,userplus)-responses">Responses</h3>

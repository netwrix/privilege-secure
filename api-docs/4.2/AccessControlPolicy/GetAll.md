...
## Retrieve all access policies. (Auth policies: MfaRequired, MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/AccessControlPolicy -Headers $Headers -ContentType "application/json"
```
...
<h3 id="retrieve-all-access-policies.-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="retrieve-all-access-policies.-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app)-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|Inline|

<h3 id="retrieve-all-access-policies.-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app)-responseschema">Response Schema</h3>

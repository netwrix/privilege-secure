...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/AccessControlPolicy/{policyId}/ManagedAccount/Remove" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

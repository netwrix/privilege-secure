...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/AccessControlPolicy/SearchManagedAccountCandidates/{accessPolicyId} -Headers $Headers -ContentType "application/json"
```

...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/AccessControlPolicy/{policyId}/Credential/Remove" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
## Copy access policy to new policy (Auth policies: MfaRequired; roles: Admin)
...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/AccessControlPolicy/Copy" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="copy-access-policy-to-new-policy-(auth-policies:-mfarequired;-roles:-admin)-parameters">Parameters</h3>
...
<h3 id="copy-access-policy-to-new-policy-(auth-policies:-mfarequired;-roles:-admin)-responses">Responses</h3>

...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/AccessControlPolicy/{policyId}/ManagedAccount" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
Invoke-RestMethod -Method DELETE -Url "$($NPSUrl)/api/v1/AccessControlPolicy/ManagedGroupAccount/{managedAccountId} -Headers $Headers -ContentType "application/json"
```

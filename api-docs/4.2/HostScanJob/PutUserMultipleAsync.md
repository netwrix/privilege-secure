...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/HostScanJob/User/Multiple/{actionQueueActionId}" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="adds-multiple-scanned-users-to-the-database-(auth-roles:-admin,app)-parameters">Parameters</h3>

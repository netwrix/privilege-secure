...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/HostScanJob/User/Multiple/{actionQueueActionId}" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

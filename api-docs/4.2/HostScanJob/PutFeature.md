...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/HostScanJob/Feature" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
## Update or create scanned host scheduled task. (Auth roles: Admin,App)

<a id="opIdPutScheduledTasks"></a>
...
curl -X PUT /api/v1/HostScanJob/ScheduledTasks \
...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/HostScanJob/ScheduledTasks" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```


</details>

`PUT /api/v1/HostScanJob/ScheduledTasks`
...
<h3 id="update-or-create-scanned-host-scheduled-task.-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[SbPAM.Models.HostScanScheduledTask](../Models/sbpam.models.hostscanscheduledtask.md)|false|List of scheduled tasks to add|
...
<h3 id="update-or-create-scanned-host-scheduled-task.-(auth-roles:-admin,app)-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|Inline|

<h3 id="update-or-create-scanned-host-scheduled-task.-(auth-roles:-admin,app)-responseschema">Response Schema</h3>

Status Code **200**

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|[[SbPAM.Models.HostScanScheduledTask](../Models/sbpam.models.hostscanscheduledtask.md)]|false|none|none|

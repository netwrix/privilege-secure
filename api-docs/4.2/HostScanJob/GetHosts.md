...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/HostScanJob/Host -Headers $Headers -ContentType "application/json"
```
...
|---|---|---|---|---|
|*anonymous*|[[SbPAM.Models.HostScanHost](../Models/sbpam.models.hostscanhost.md)]|false|none|none|

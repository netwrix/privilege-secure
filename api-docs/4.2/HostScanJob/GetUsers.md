...
## Get scanned users. (Auth roles: Admin,App)
...
curl -X GET /api/v1/HostScanJob/User \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/HostScanJob/User -Headers $Headers -ContentType "application/json"
```


</details>

`GET /api/v1/HostScanJob/User`
...
<h3 id="get-scanned-users.-(auth-roles:-admin,app)-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|Inline|

<h3 id="get-scanned-users.-(auth-roles:-admin,app)-responseschema">Response Schema</h3>

Status Code **200**

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|[[SbPAM.Models.HostScanUser](../Models/sbpam.models.hostscanuser.md)]|false|none|none|

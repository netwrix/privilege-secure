...
## Get scanned group. (Auth roles: Admin,App)
...
curl -X GET /api/v1/HostScanJob/Group/{groupId} \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/HostScanJob/Group/{groupId} -Headers $Headers -ContentType "application/json"
```


</details>

`GET /api/v1/HostScanJob/Group/{groupId}`

<h3 id="get-scanned-group.-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-scanned-group.-(auth-roles:-admin,app)-responses">Responses</h3>

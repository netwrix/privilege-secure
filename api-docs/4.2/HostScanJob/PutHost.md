...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/HostScanJob/Host" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/ManagedResource/{managedResourceId}" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

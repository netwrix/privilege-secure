...
## Update managed resource (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/ManagedResource/{managedResourceId}" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```
...
<h3 id="update-managed-resource-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="update-managed-resource-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

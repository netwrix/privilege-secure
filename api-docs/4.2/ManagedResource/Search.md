...
## Search for managed resources (Auth policies: MfaRequired, MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/Search" -Headers $Headers -ContentType "application/json"
```
...
<h3 id="search-for-managed-resources-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="search-for-managed-resources-(auth-policies:-mfarequired,-mfarequired;-roles:-admin,app)-responses">Responses</h3>

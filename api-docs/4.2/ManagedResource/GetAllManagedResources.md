...
<h3 id="get-all-managed-resources-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>
...
<h3 id="get-all-managed-resources-(auth-policies:-mfarequired;-roles:-admin,app)-responseschema">Response Schema</h3>

...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/{managedResourceId}/ProtectedGroup" -Headers $Headers -ContentType "application/json"
```
...
<h3 id="return-protected-groups-for-given-resource-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>
...
<h3 id="return-protected-groups-for-given-resource-(auth-policies:-mfarequired;-roles:-admin,app)-responseschema">Response Schema</h3>

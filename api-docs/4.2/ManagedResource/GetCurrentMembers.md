...
## Get the current members of a protected group (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/ManagedResource/ProtectedGroup/{groupId}/CurrentMembers -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-the-current-members-of-a-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|groupId|path|string(uuid)|true|Unique id of member|
...
<h3 id="get-the-current-members-of-a-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>
...
<h3 id="get-the-current-members-of-a-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-responseschema">Response Schema</h3>

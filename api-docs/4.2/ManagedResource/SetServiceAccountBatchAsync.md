...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/ManagedResource/ServiceAccount/Bulk" -ContentType "application/json" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

...
Invoke-RestMethod -Method PUT -Uri "$($NPSUrl)/api/v1/ManagedResource/TestConnection/{resourceId}/{testId}/Step" -Body $JsonBody -Headers $Headers -ContentType "application/json"
```

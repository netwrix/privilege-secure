...
## Get managed resource for activity directory domain config (Auth policies: MfaRequired; roles: Admin,App)

<a id="opIdGetManagedResourceByDomainConfigId"></a>
...
curl -X GET /api/v1/ManagedResource/ByDomainConfigId/{domainConfigId} \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/ByDomainConfigId/{domainConfigId} -Headers $Headers -ContentType "application/json"
```


</details>

`GET /api/v1/ManagedResource/ByDomainConfigId/{domainConfigId}`

<h3 id="get-managed-resource-for-activity-directory-domain-config-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|domainConfigId|path|string(uuid)|true|ActiveDirectory domain configuration id|
...
<h3 id="get-managed-resource-for-activity-directory-domain-config-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

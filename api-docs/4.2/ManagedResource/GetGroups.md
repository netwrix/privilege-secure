...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/{managedResourceId}/Group" -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-resource-groups-that-resource-is-a-member-of-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>
...
<h3 id="get-resource-groups-that-resource-is-a-member-of-(auth-policies:-mfarequired;-roles:-admin,app)-responseschema">Response Schema</h3>

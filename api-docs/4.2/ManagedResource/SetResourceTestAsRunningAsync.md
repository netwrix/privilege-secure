...
## Mark the resource test as running (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method PUT -Url "$($NPSUrl)/api/v1/ManagedResource/TestConnection/{resourceId}/{testId}/Running -Headers $Headers -ContentType "application/json"
```
...
<h3 id="mark-the-resource-test-as-running-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="mark-the-resource-test-as-running-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

...
## Gets a resource with its protected groups (Auth policies: MfaRequired; roles: App)
...
curl -X GET /api/v1/ManagedResource/ResourceWithProtectedGroups/{managedResourceId} \
...
Invoke-RestMethod -Method GET -Uri "$($NPSUrl)/api/v1/ManagedResource/ResourceWithProtectedGroups/{managedResourceId}" -Headers $Headers -ContentType "application/json"
```
...
<h3 id="gets-a-resource-with-its-protected-groups-(auth-policies:-mfarequired;-roles:-app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|managedResourceId|path|string(uuid)|true|Resource Id|
|allGroups|query|boolean|false|Include all protected groups, not just those with protection policies|
...
<h3 id="gets-a-resource-with-its-protected-groups-(auth-policies:-mfarequired;-roles:-app)-responses">Responses</h3>

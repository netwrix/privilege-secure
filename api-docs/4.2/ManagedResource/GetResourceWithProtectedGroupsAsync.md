...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/ManagedResource/ResourceWithProtectedGroups/{managedResourceId} -Headers $Headers -ContentType "application/json"
```

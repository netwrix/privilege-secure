...
## Remove protected group (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method DELETE -Url "$($NPSUrl)/api/v1/ManagedResource/ProtectedGroup/{groupId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="remove-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="remove-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

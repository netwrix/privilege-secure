...
## Get list of members for protected group (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/ManagedResource/ProtectedGroup/{groupId}/AllowedMembers -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-list-of-members-for-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-list-of-members-for-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>
...
<h3 id="get-list-of-members-for-protected-group-(auth-policies:-mfarequired;-roles:-admin,app)-responseschema">Response Schema</h3>

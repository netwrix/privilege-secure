...
## Get managed resource by hostscan host id (Auth policies: MfaRequired; roles: Admin,App)
...
Invoke-RestMethod -Method GET -Url "$($NPSUrl)/api/v1/ManagedResource/ByHostScanHostId/{hostScanHostId} -Headers $Headers -ContentType "application/json"
```
...
<h3 id="get-managed-resource-by-hostscan-host-id-(auth-policies:-mfarequired;-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="get-managed-resource-by-hostscan-host-id-(auth-policies:-mfarequired;-roles:-admin,app)-responses">Responses</h3>

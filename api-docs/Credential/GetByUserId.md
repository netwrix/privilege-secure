...
## Get credential by user id (Auth roles: App)

<a id="opIdGetByUserId"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/Credential/ByUserId/{userId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/Credential/ByUserId/{userId} -Headers $Headers
```

`GET /api/v1/Credential/ByUserId/{userId}`

<h3 id="get-credential-by-user-id-(auth-roles:-app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|userId|path|string(uuid)|true|none|
|generate|query|boolean|false|none|
|rollback|query|boolean|false|none|
|showPassword|query|boolean|false|none|
|save|query|boolean|false|none|
...
<h3 id="get-credential-by-user-id-(auth-roles:-app)-responses">Responses</h3>

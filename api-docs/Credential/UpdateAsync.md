...
## Update an existing credential (Auth roles: Admin,App)

<a id="opIdUpdateAsync"></a>
...
<h3 id="update-an-existing-credential-(auth-roles:-admin,app)-parameters">Parameters</h3>
...
<h3 id="update-an-existing-credential-(auth-roles:-admin,app)-responses">Responses</h3>

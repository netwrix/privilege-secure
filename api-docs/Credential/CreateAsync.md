...
## Create a new credential (Auth roles: Admin)
...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/Credential" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```
...
<h3 id="create-a-new-credential-(auth-roles:-admin)-parameters">Parameters</h3>
...
<h3 id="create-a-new-credential-(auth-roles:-admin)-responses">Responses</h3>

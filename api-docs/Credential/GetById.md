...
## Get specific credential by Id (Auth roles: Admin,App)
...
curl -X GET /api/v1/Credential/{credentialId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/Credential/{credentialId} -Headers $Headers
```

`GET /api/v1/Credential/{credentialId}`

<h3 id="get-specific-credential-by-id-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|credentialId|path|string(uuid)|true|none|
|showPassword|query|boolean|false|none|
...
<h3 id="get-specific-credential-by-id-(auth-roles:-admin,app)-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|[SbPAM.Models.CredentialDto](../Models/sbpam.models.credentialdto.md)|

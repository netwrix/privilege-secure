...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/Credential/AddCredentialSSHCertificate/{credentialId}" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```

...
## Update existing credential (Auth roles: Admin,App)
...
Invoke-RestMethod -Method PUT -Url "$($Host)/api/v1/Credential" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```
...
<h3 id="update-existing-credential-(auth-roles:-admin,app)-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|erasePassword|query|boolean|false|none|
...
<h3 id="update-existing-credential-(auth-roles:-admin,app)-responses">Responses</h3>

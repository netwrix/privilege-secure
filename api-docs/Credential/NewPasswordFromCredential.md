...
## Create a copy of an existing credential, generating a new password for the clone (Auth roles: App)

<a id="opIdNewPasswordFromCredential"></a>

> Code samples

```shell
# You can also use wget
curl -X GET /api/v1/Credential/NewCredentialFromCredential/{credentialId} \
  -H 'Accept: text/plain' \
...
Invoke-RestMethod -Method GET -Url "$($Host)/api/v1/Credential/NewCredentialFromCredential/{credentialId} -Headers $Headers
```

`GET /api/v1/Credential/NewCredentialFromCredential/{credentialId}`

<h3 id="create-a-copy-of-an-existing-credential,-generating-a-new-password-for-the-clone-(auth-roles:-app)-parameters">Parameters</h3>
...
<h3 id="create-a-copy-of-an-existing-credential,-generating-a-new-password-for-the-clone-(auth-roles:-app)-responses">Responses</h3>

...
Invoke-RestMethod -Method POST -Url "$($Host)/api/v1/Credential/GenerateUserSSHCertificate/{userId}" -ContentType "application/json-patch+json" -Body $JsonBody -Headers $Headers
```
